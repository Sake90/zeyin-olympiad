  ...
  try {
    ...
    const { data: copy, error: copyErr } = await db
      ...
      .insert({
        ...
        status: 'draft',
        intro_video_url_ru: src.intro_video_url_ru,
        intro_video_url_kz: src.intro_video_url_kz,
        intro_text_ru: src.intro_text_ru,
        intro_text_kz: src.intro_text_kz,
        outro_video_url_ru: src.outro_video_url_ru,
        outro_video_url_kz: src.outro_video_url_kz,
